...
@pytest.mark.parametrize(
    "clock_in, clock_out",
    [
        (datetime.datetime(2023, 1, 1, 0, 0, 0, 0), datetime.datetime(2023, 1, 1, 0, 0, 0, 0)),
        (datetime.datetime(2023, 1, 1, 0, 0, 0, 1), datetime.datetime(2023, 1, 1, 0, 0, 0, 0)),
    ],
)
...
@pytest.mark.parametrize(
    "clock_in, clock_out", [(datetime.datetime(2023, 1, 1, 0, 0, 0, 0), datetime.datetime(2023, 1, 1, 0, 0, 0, 1))]
)
...
single_attendance = [
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 8), clock_out=datetime.datetime(2023, 1, 1, 10))
]
normal_attendances = [
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 8), clock_out=datetime.datetime(2023, 1, 1, 10)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 11), clock_out=datetime.datetime(2023, 1, 1, 14)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 15), clock_out=datetime.datetime(2023, 1, 1, 20)),
]
attendances_with_intersection = [
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 8), clock_out=datetime.datetime(2023, 1, 1, 10)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 9), clock_out=datetime.datetime(2023, 1, 1, 14)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 13), clock_out=datetime.datetime(2023, 1, 1, 20)),
]
begin_interception = [
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 8), clock_out=datetime.datetime(2023, 1, 1, 10)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 9), clock_out=datetime.datetime(2023, 1, 1, 10)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 13), clock_out=datetime.datetime(2023, 1, 1, 17)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 13), clock_out=datetime.datetime(2023, 1, 1, 20)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 14), clock_out=datetime.datetime(2023, 1, 1, 15)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 15), clock_out=datetime.datetime(2023, 1, 1, 16)),
]
attendances_with_inception = [
    ...
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 14), clock_out=datetime.datetime(2023, 1, 1, 15)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 15), clock_out=datetime.datetime(2023, 1, 1, 16)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 15), clock_out=datetime.datetime(2023, 1, 1, 21)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 20), clock_out=datetime.datetime(2023, 1, 1, 22)),
]
multiple_days = [
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 8), clock_out=datetime.datetime(2023, 1, 2, 2)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 2, 18), clock_out=datetime.datetime(2023, 1, 3, 19)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 3, 13), clock_out=datetime.datetime(2023, 1, 4, 5)),
]
random_order = [
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 15, 8), clock_out=datetime.datetime(2023, 1, 15, 10)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 14, 9), clock_out=datetime.datetime(2023, 1, 14, 10)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 20, 13), clock_out=datetime.datetime(2023, 1, 20, 17)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 13), clock_out=datetime.datetime(2023, 1, 1, 20)),
    verifier.Attendance(clock_in=datetime.datetime(2022, 12, 31, 14), clock_out=datetime.datetime(2022, 12, 31, 15)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 15), clock_out=datetime.datetime(2023, 1, 1, 16)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 2, 4, 15), clock_out=datetime.datetime(2023, 2, 4, 21)),
    verifier.Attendance(clock_in=datetime.datetime(2023, 1, 1, 20), clock_out=datetime.datetime(2023, 1, 1, 22)),
]
